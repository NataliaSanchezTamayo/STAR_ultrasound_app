...
#define PROC_FORMAT_STRING_SIZE   6281                              
...
/* 6252 */	NdrFcShort( 0x7 ),	/* 7 */
/* 6254 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 6256 */	NdrFcShort( 0x8 ),	/* 8 */
/* 6258 */	NdrFcShort( 0x8 ),	/* 8 */
/* 6260 */	0x5,		/* Oi2 Flags:  srv must size, has return, */
			0x3,		/* 3 */

	/* Parameter FilterIndex */

/* 6262 */	NdrFcShort( 0x48 ),	/* Flags:  in, base type, */
/* 6264 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 6266 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */

	/* Parameter pVal */

/* 6268 */	NdrFcShort( 0x13 ),	/* Flags:  must size, must free, out, */
/* 6270 */	NdrFcShort( 0x8 ),	/* x86 Stack size/offset = 8 */
/* 6272 */	NdrFcShort( 0x1da ),	/* Type Offset=474 */

	/* Return value */

/* 6274 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 6276 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 6278 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
